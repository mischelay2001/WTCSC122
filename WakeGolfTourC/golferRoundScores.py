class GolferRoundScores:
    ...
    def __str__(self):
        ...
        """
        csv_str = str(self.__golfer_round_id) + ',' + \
                  str(self.__tourn_golfer_id) + ',' + \
                  str(self.__round_id) + ',' + \
                  str(self.__total_round_score) + ',' + \
                  str(self.__hole1_score) + ',' + \
                  str(self.__hole2_score) + ',' + \
                  str(self.__hole3_score) + ',' + \
                  str(self.__hole4_score) + ',' + \
                  str(self.__hole5_score) + ',' + \
                  str(self.__hole6_score) + ',' + \
                  str(self.__hole7_score) + ',' + \
                  str(self.__hole8_score) + ',' + \
                  str(self.__hole9_score) + ',' + \
                  str(self.__hole10_score) + ',' + \
                  str(self.__hole11_score) + ',' + \
                  str(self.__hole12_score) + ',' + \
                  str(self.__hole13_score) + ',' + \
                  str(self.__hole14_score) + ',' + \
                  str(self.__hole15_score) + ',' + \
                  str(self.__hole16_score) + ',' + \
                  str(self.__hole17_score) + ',' + \
                  str(self.__hole18_score)
        return csv_str
